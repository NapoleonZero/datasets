 ...
 */
static Boolean
comments_in_move_list(const Move *move_list)
{
...
static Boolean
check_for_comments(const Game *game)
{
...
deal_with_ECO_line(Move *move_list)
{
     ...
     */
    Board *final_position = apply_eco_move_list(&current_game, &number_of_half_moves);
